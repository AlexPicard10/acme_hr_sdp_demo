...
if mode == "seed":
    ...
    save_state(roster)
    write_jsonl(employee_extract(roster, today), "employees", f"employees_{today}.json")
    ...
    save_state(roster)
    write_jsonl(employee_extract(roster, today), "employees", f"employees_{today}_{ts}.json")
